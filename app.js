...
mongoose.connect('mongodb+srv://' + process.env.SECRET + '@cluster0.819nn.mongodb.net/todolistDB', { useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false });
